...
namespace MCHMIS.Areas.Admin.Controllers
{
    ...
    public class SystemSettingsController : Controller
    {
        ...
        public IActionResult Create([Bind("Id,key,Value")] SystemSetting systemSetting)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult Edit(int id, [Bind("Id,key,Value")] SystemSetting systemSetting)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    _uow.GetRepository<SystemSetting>().Update(systemSetting);
                    _uow.Save();
                }
