            ...
            using (DbDataReader dr = databaseFacade.ExecuteSqlQuery(sql, parameters).DbDataReader)
            {
                ...
                while (dr.Read())
                {
                    ...
                    for (int i = 0; i < props.Length; ++i)
                    {
                        ...
                        System.ComponentModel.DataAnnotations.Schema.ColumnAttribute ca =
                            pi.GetCustomAttribute(typeof(System.ComponentModel.DataAnnotations.Schema.ColumnAttribute))
                        ...
                        bool nullable = pt.GetTypeInfo().IsGenericType &&
